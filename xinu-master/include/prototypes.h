...
/* in file getitem_new.c -assignment3*/
extern  pid32   getfirst_new(qid16);
extern  pid32   getlast_new(qid16);
extern  pid32   getitem_new(pid32);
...
/* in file insert_new.c -assignment3*/
extern  status  insert_new(pid32, qid16, int32);
...
/* in file newqueue_new.c -assignment3*/
extern  qid16   newqueue_new(void);
...
/* in file resched_new.c assignment3 */
extern	void	resched(void);
//extern	status	resched_cntl(int32);
